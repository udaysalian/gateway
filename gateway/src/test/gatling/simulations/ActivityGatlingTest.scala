...
class ActivityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activity entity")
        ...
        .repeat(2) {
            ...
            .post("/api/activities")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "contrId":"SAMPLE_TEXT", "activityNbr":"SAMPLE_TEXT", "rcptLocNbr":"SAMPLE_TEXT", "dlvryLocNbr":"SAMPLE_TEXT", "updater":"SAMPLE_TEXT", "updateTimeStamp":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
